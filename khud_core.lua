...
KineticHUD.hud_values = {
	...
	world_panels = {
		...
		},
		{
			...
			existing_parent = "fullscreen_workspace"
		},
		{
...
--once settings are loaded, setting entries are organized into tables by workspace/panel and stored here
--data stored can be either world workspaces or flatscreen workspaces
KineticHUD.workspace_values = { --NOT USED
	DEFAULT = {
		name = "default",
		debug_text = "default panel",
		debug_alpha = 0.2,
		...
		parent_panel_name = "fullscreen_workspace", --only used for flatscreen workspaces
		is_world_workspace = true,
		world_w = 0,
		world_h = 0,
		autoscale_world_size = true,
		world_to_panel_scale = 100, --if autoscale_world_size is true, world_w and world_h are discarded and instead automatically generated by the quotient of the dimension by this number
		valign = "top",
		halign = "right",
		rotation_yaw = 0, 
		rotation_pitch = 0,
		rotation_roll = 0,
		position_x = 0, --horizontal distance
		position_y = 0, --vertical distance
		position_z = 0 --forward/backward distance from camera
	}
}
...
KineticHUD.default_layout_settings = {
	--player vitals
	--player weapons
	--player equipment/missionequipment
	--teammates
