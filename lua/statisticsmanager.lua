...
--	KineticHUD:c_log(KineticHUD:concat({stats_name,name,name_id,_type}))
	...
	local weapon_id = weapon_unit and weapon_unit:base():get_name_id()
...
--		KineticHUD:c_log(equipped_primary.custom_name or "[no name]","Got a kill with primary weapon nicknamed ")
	end
...
--		KineticHUD:c_log(equipped_secondary.custom_name or "[no name]","Got a kill with secondary weapon nicknamed ")
	end
